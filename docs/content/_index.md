---
title: "datacite"
description: "A command line for datacite."
heroTitle: "datacite, from the command line"
heroLead: "A command line for datacite. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
datacite links <path>           # the pages it links to, each addressable
datacite serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading datacite by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address datacite as
  `datacite://` URIs and follow links across sites. See
