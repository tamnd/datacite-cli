...
Most of these come down to network reality or how datacite serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

datacite rate-limits like any public site. datacite already paces
...
Where a surface is gated, datacite reads a cookie or token you supply
...
`datacite`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what datacite actually did
