...
func TestHostWiring(t *testing.T) {
	...
	if want := "datacite://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("datacite", "about")
	if err != nil || got.String() != "datacite://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want datacite://page/about", got.String(), err)
	}
}
